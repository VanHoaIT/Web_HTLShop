...
<body>
    ...
    <header>
                ...
                <li class="menu-items">
                    ...
                    <ul class="sub-nav-sanpham">
                        <li class="sub-nav-sanpham-items">
                            ...
                            <a href="./web-page/products/product.php#phone-product"><i
                                    class="fa-solid fa-laptop"></i>Iphone</a>
                            <a href="./web-page/products/product.php#phone-product"><i
                                    class="fa-solid fa-laptop"></i>SamSung</a>
                            <a href="./web-page/products/product.php#phone-product"><i
                                    class="fa-solid fa-laptop"></i>Xiaomi</a>
                            <a href="./web-page/products/product.php#phone-product"><i
                                    class="fa-solid fa-laptop"></i>Vsmart</a>
                        </li>
                        ...
                        <li class="sub-nav-sanpham-items">
                            ...
                            <a href="./web-page/products/product.php#laptop-gaming"><i
                                    class="fa-solid fa-laptop"></i>Laptop Gaming</a>
                            <a href="./web-page/products/product.php#laptop-dell"><i
                                    class="fa-solid fa-laptop"></i>Laptop Dell</a>
                            <a href="./web-page/products/product.php#laptop-asus"><i
                                    class="fa-solid fa-laptop"></i>Laptop Asus</a>
                            <a href="./web-page/products/product.php#laptop-macbook"><i
                                    class="fa-solid fa-laptop"></i>Laptop MAC OS</a>
                        </li>
                        ...
                        <li class="sub-nav-sanpham-items">
                            ...
                            <a href="./web-page/products/product.php#container-screen-product"><i
                                    class="fa-solid fa-desktop"></i>ViewSonic</a>
                            <a href="./web-page/products/product.php#container-screen-product"><i
                                    class="fa-solid fa-desktop"></i>TCL</a>
                            <a href="./web-page/products/product.php#container-screen-product"><i
                                    class="fa-solid fa-desktop"></i>DELL</a>
                            <a href="./web-page/products/product.php#container-screen-product"><i
                                    class="fa-solid fa-desktop"></i>LG</a>
                            <a href="./web-page/products/product.php#container-screen-product"><i
                                    class="fa-solid fa-desktop"></i>Gaming</a>
                            <a href="./web-page/products/product.php#container-screen-product"><i
                                    class="fa-solid fa-desktop"></i>AOC</a>
                            <a href="./web-page/products/product.php#container-screen-product"><i
                                    class="fa-solid fa-desktop"></i>SamSung</a>
                        </li>
                        ...
                        <li class="sub-nav-sanpham-items">
                            ...
                            <a href="./web-page/products/product.php#mouse-product-container"><i
                                    class="fa-solid fa-computer-mouse"></i>Logitech</a>
                            <a href="./web-page/products/product.php#mouse-product-container"><i
                                    class="fa-solid fa-computer-mouse"></i>E-Dra</a>
                            <a href="./web-page/products/product.php#mouse-product-container"><i
                                    class="fa-solid fa-computer-mouse"></i>Havit</a>
                            <a href="./web-page/products/product.php#mouse-product-container"><i
                                    class="fa-solid fa-computer-mouse"></i>Lanovel</a>
                            <a href="./web-page/products/product.php#mouse-product-container"><i
                                    class="fa-solid fa-computer-mouse"></i>Razer</a>
                        </li>
                        ...
                        <li class="sub-nav-sanpham-items">
                            ...
                            <a href="./web-page/products/product.php#keyboard"><i
                                    class="fa-solid fa-keyboard"></i>Corsair</a>
                            <a href="./web-page/products/product.php#keyboard"><i
                                    class="fa-solid fa-keyboard"></i>Filco</a>
                            <a href="./web-page/products/product.php#keyboard"><i
                                    class="fa-solid fa-keyboard"></i>Ducky</a>
                            <a href="./web-page/products/product.php#keyboard"><i
                                    class="fa-solid fa-keyboard"></i>Hyper-X</a>
                            <a href="./web-page/products/product.php#keyboard"><i
                                    class="fa-solid fa-keyboard"></i>leopold</a>
                            <a href="./web-page/products/product.php#keyboard"><i
                                    class="fa-solid fa-keyboard"></i>Fuhlen</a>
                            <a href="./web-page/products/product.php#keyboard"><i
                                    class="fa-solid fa-keyboard"></i>AKKO</a>
                        </li>
                        ...
                        <li class="sub-nav-sanpham-items">
                            ...
                            <a href="./web-page/products/product.php#headphone"><i
                                    class="fa-solid fa-headphones"></i>Kane</a>
                            <a href="./web-page/products/product.php#headphone"><i
                                    class="fa-solid fa-headphones"></i>Mozard</a>
                            <a href="./web-page/products/product.php#headphone"><i
                                    class="fa-solid fa-headphones"></i>Skullcandy</a>
                            <a href="./web-page/products/product.php#headphone"><i
                                    class="fa-solid fa-headphones"></i>Dorado</a>
                            <a href="./web-page/products/product.php#headphone"><i
                                    class="fa-solid fa-headphones"></i>Solaric</a>
                        </li>
                    </ul>
                </li>
                <li class="menu-items-logo"><a href="./index.php" class="menu-logo"><img
                            src="./asset/picture/logo/logo-icon-title.jpg" alt="" class="logo-menu"></a></li>
        ...
        <div class="right-header">
            ...
            <div class="right-header-icon js-right-header-card" title="Giỏ Hàng">
                <a href="./web-page/CartShopping/CartShopping.php" style="color: #fff;"><i
    ...
    <section class="featured-products">
        ...
        <div class="container-menu menu-screen-pc">
            ...
            ?>
                ...
                <div class="menu-load">
                    <a
                        href="./web-page/all-product/all-product.php?loai=<?php echo $row['LoaiSP'];?>&maloai=<?php echo $row['MaLoai'];?>">
    ...
    <footer>
        <div class="footer-items">
            ...
            <ul class="lish-icon-media">
                <li>
                    <a href="https://www.facebook.com/voduylong.0611" target="_blank"><i class="fa-brands fa-facebook"
                            title="Facebook"></i></a>
                </li>
                <li>
                    <a href="https://www.facebook.com/voduylong.0611" target="_blank" title="messenger"><i
                            class="fa-solid fa-comment-sms"></i></a>
                </li>
                <li>
                    <a href="https://www.instagram.com/long.vdl/" target="_blank" title="Instagram"><i
                            class="fa-brands fa-instagram"></i></a>
                </li>
                <li>
                    <a href="https://voduylongnn.github.io/" target="_blank" title="Website"><i
                            class="fa-brands fa-google"></i></a>
                </li>
                <li>
                    <a href="https://www.youtube.com/channel/UC45TnS0b7uqk_khLz_6wMtA/featured" target="_blank"
                        title="Youtube"><i class="fa-brands fa-youtube"></i></a>
                </li>
                <li>
                    <a href="https://github.com/VoDuyLongNN" target="_blank" title="Github"><i
    ...
    <div class="search js-search">
        <div class="search-container">
            ...
            <form action="./web-page/all-product/all-product.php" method="GET" style="display: flex;">
                <input type="search" name="search" id="" class="input-search" placeholder="Bạn muốn tìm kiếm gì?">
                <div class="search-icon-form js-search-icon" style="font-size: 20px;
                  margin-left: 0;
                  cursor: pointer;
                  padding: 0 10px;
                  display: flex;">
